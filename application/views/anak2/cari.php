            ...
            <div class="row" style="padding-left:20px;padding-right:20px">
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <label>Umur</label>
                        <input class="form-control" name="umur" id="umur" value="<?= isset($umur)?$umur:''; ?>">
                            ...
                            if ($jumlah > 0) {
                                ...
                                foreach ($data as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo isset($row->umur) ? $row->umur : ''; ?></td>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?= base_url() ?>index.php/anak/delete/<?= md5(sha1($row->id_anak)) ?>" class="delete"  title="Delete"><img src="<?= base_url('images') ?>/delete.png" style="width:15px;height:15px;"></a>
                                        </td> 
                                    </tr>
                                    <?php $no++; ?>    
                                    <?php
