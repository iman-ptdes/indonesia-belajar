        ...
        <div class="tab-pane active" id="data_diri">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" name="tanggal_lahir" id="tanggal_lahir" value="<?= $tanggal_lahir ?>"/>
                </div>
            </div>
             <div class="form-group">
                    <label class="col-lg-5 control-label">Umur</label>
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="umur" value="<?= (isset($row->umur)) ? $row->umur : '' ?>"/>
                    </div>
                </div>
            <div class="form-group">
