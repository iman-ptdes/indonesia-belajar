...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('cssjs') ?>/startbootstrap-agency-1.0.4/css/agency.css"/>
        ...
        <!-- Custom Fonts -->
    <link href="<?= base_url('cssjs') ?>/startbootstrap-agency-1.0.4/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <body id="page-top" class="index">
        ...
        <header>
            <div class="container">
                <div class="intro-text">
                    <div class="intro-lead-in">Ayo Semangat Belajar!</div>
                    <div class="intro-heading">Gapai Cita - Citamu</div>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <span class="copyright">Copyright &copy; Desnet 2015</span>
                    </div>
<!--                    <div class="col-md-4">
        ...
        <script type="text/javascript" src="<?= base_url('cssjs') ?>/startbootstrap-agency-1.0.4/js/classie.js"></script>
        <script type="text/javascript" src="<?= base_url('cssjs') ?>/startbootstrap-agency-1.0.4/js/cbpAnimatedHeader.js"></script>
        <script type="text/javascript" src="<?= base_url('cssjs') ?>/startbootstrap-agency-1.0.4/js/agency.js"></script>
