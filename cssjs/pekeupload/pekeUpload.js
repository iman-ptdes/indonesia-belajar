...
(function ($) {
    ...
    $.fn.pekeUpload = function (options) {
        ...
        var defaults = {
            onSubmit: false,
            btnText: "Lampirkan file",
            url: window.location.host + "aktivitas/aktivitas/upload",
            theme: "custom",
            field: "file",
            data: null,
            multi: true,
        ...
        this.each(function () {
            ...
            if (options.theme == "custom") {
                var html = '<a href="javascript:void(0)" class="button small">' + options.btnText + '</a><div class="pekecontainer"></div>';
            }
            obj.after(html);
            obj.hide();
